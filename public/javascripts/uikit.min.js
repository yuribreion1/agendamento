...
! function (t, e) {
    ...
    function xt(t, e) {
        return w(e, ">") && (e = e.slice(1)), _(t) ? yt.call(t, e) : V(t).map(function (t) {
            return xt(t, e)
        }).filter(Boolean)
    }
    ...
    function ue(t, e, n, i) {
        ...
        var r = (e = V(e)).length;
        return t = B(t) ? F(t) : "next" === t ? n + 1 : "previous" === t ? n - 1 : ce(e, t), i ? Z(t, 0, r - 1) : (t %= r) < 0 ? t + r : t
    }
    ...
    function Oe(t) {
        ...
        if (i.length) {
            ...
            i = i.filter(Boolean), V(t).forEach(function (t) {
                for (var e = t.classList, n = 0; n < i.length; n++) Be.Force ? e.toggle.apply(e, [i[n]].concat(r)) : e[(H(r) ? !e.contains(i[n]) : r) ? "add" : "remove"](i[n])
            })
        }
    }
            ...
            return new Rt(function (i, r) {
                if (Me(s, Ke)) requestAnimationFrame(function () {
                    ...
                    w(e, Xe) && (a && (t += " uk-transform-origin-" + a), h && (t += " " + Xe + "reverse")), o(), Dt(s, "animationend animationcancel", function (t) {
                        var e = t.type,
                            n = !1;
                        "animationcancel" === e ? (r(), o()) : (i(), Rt.resolve().then(function () {
                            n = !0, o()
    ...
    function vn(t, e, n) {
        return void 0 === e && (e = "width"), void 0 === n && (n = window), B(t) ? +t : u(t, "vh") ? wn(on(bn(n)), t) : u(t, "vw") ? wn(sn(bn(n)), t) : u(t, "%") ? wn(nn(n)[e], t) : j(t)
    }
    ...
    function $n(t) {
        void 0 === t && (t = !1), xn.scheduled || (xn.scheduled = !0, t ? Rt.resolve().then(kn) : requestAnimationFrame(kn))
    }
    ...
    function Li(t, e, n, i) {
        if (Yi(t)) i && (t.sizes = i), n && (t.srcset = n), e && (t.src = e);
            ...
            !y(t.style.backgroundImage, e) && (He(t, "backgroundImage", "url(" + It(e) + ")"), zt(t, Bt("load", !1)))
        }
    }
    ...
    var Gi, Ji, Zi = {
        ...
        tr = {
            ...
            events: [{
                ...
                self: !0,
                handler: function () {
                    Me(document.documentElement, this.clsPage) || (this.scrollbarWidth = sn(window) - sn(document), He(document.body, "overflowY", this.scrollbarWidth && this.overlay ? "scroll" : "")), Ce(document.documentElement, this.clsPage)
                }
            }, {
                name: "hide",
                self: !0,
            ...
            methods: {
                ...
                show: function () {
                    var e = this;
                    return this.container && this.$el.parentNode !== this.container ? (fe(this.container, this.$el), new Rt(function (t) {
            ...
            methods: {
                ...
                transitionTo: function (t, e) {
                    var n = this,
                        i = this.dropbar,
                        r = Et(i) ? on(i) : 0;
                    return He(e = r < t && e, "clip", "rect(0," + e.offsetWidth + "px," + r + "px,0)"), on(i, r), Ue.cancel([e, i]), Rt.all([Ue.start(i, {
                        height: t
                ...
                write: function (r) {
                    ...
                    this.elements.forEach(function (t) {
                        ...
                        if (!n.show || n.inview || n.queued) {
                            ...
                            var i = function () {
                                He(t, "visibility", ""), Ce(t, o.inViewClass), Oe(t, e), zt(t, "inview"), o.$update(t), n.inview = !0, n.abort && n.abort()
                            };
            ...
            update: [{
                ...
                write: function (t) {
                    ...
                    this.links.forEach(function (t) {
                        return t.blur()
                    }), Ae(this.elements, this.cls), e && zt(this.$el, "active", [e, Ce(this.closest ? xt(e, this.closest) : e, this.cls)])
                },
                events: ["scroll", "resize"]
            }]
        },
        dr = {
            ...
            update: [{
                ...
                write: function (t) {
                    ...
                    He(i, X({
                        height: e
                    }, n)), Nt(i, document) || (me(this.$el, i), it(i, "hidden", "")), this.isActive = this.isActive
                },
                events: ["resize"]
            }, {
                read: function (t) {
                ...
                show: function (t) {
                    for (var e, n, i = this, r = this.$el.children, o = r.length, s = this.index(), a = 0 <= s, h = "previous" === t ? -1 : 1, c = ue(t, r, s), u = 0; u < o; u++, c = (c + h + o) % o)
                        if (!bt(this.toggles[c], ".uk-disabled *, .uk-disabled, [disabled]")) {
                            ...
                            break
                        }! n || 0 <= s && Me(n, this.cls) || s === c || (Ae(r, this.cls), Ce(n, this.cls), it(this.toggles, "aria-expanded", !1), it(e, "aria-expanded", !0), this.connects.forEach(function (t) {
            ...
            methods: {
                animate: function (t) {
                    ...
                    return o = a.map(function (t, e) {
                        ...
                        return n
                    }), Ce(this.target, yr), r.forEach(function (t, e) {
                        return o[e] && He(t, o[e])
                    }), He(this.target, "height", e), mn(window, n), Rt.all(r.map(function (t, e) {
        ...
        methods: {
            ...
            setState: function (o, t) {
                ...
                void 0 === t && (t = !0), o = X({
                    ...
                    sort: []
                }, o), zt(this.$el, "beforeFilter", [this, o]);
                var a = this.children;
                this.toggles.forEach(function (t) {
                ...
                move: function (t) {
                    ...
                    if (this.unbindMove) {
                        ...
                        if (!(0 == n || this.prevPos === this.pos || !this.dragging && Math.abs(n) < this.threshold)) {
                            ...
                            }), (this.index === r && this.prevIndex !== r || h) && zt(i[this.index], "itemshown", [this]), l && (this.prevIndex = r, this.index = s, d || zt(c, "beforeitemhide", [this]), zt(u, "beforeitemshow", [this])), this._transitioner = this._translate(Math.abs(this.percent), c, !d && u), l && (d || zt(c, "itemhide", [this]), zt(u, "itemshow", [this]))
                        }
                    }
                },
                end: function () {
        ...
        methods: {
                    ...
                    if (i[e ? "unshift" : "push"](t), !e && 1 < i.length) 2 === i.length && this._transitioner.forward(Math.min(this.duration, 200));
                        ...
                        if (a !== c) {
                            if (this.dir = function (t, e) {
                                ...
                                }(t, s), this.prevIndex = s, this.index = h, a && zt(a, "beforeitemhide", [this]), !zt(c, "beforeitemshow", [this, a])) return this.index = this.prevIndex, void o();
                            var u = this._show(a, c, e).then(function () {
                                return a && zt(a, "itemhidden", [n]), zt(c, "itemshown", [n]), new Rt(function (t) {
                                    xn.write(function () {
            ...
            _show: function (t, e, n) {
                if (this._transitioner = this._getTransitioner(t, e, this.dir, X({
                    ...
                    }, this.transitionOptions)), !n && !t) return this._transitioner.translate(1), Rt.resolve();
    ...
    var Br = {
        ...
        Pr = {
            ...
            events: [{
                ...
                name: "beforeitemshow",
                handler: function (t) {
                    this.isToggled() || (this.draggable = !1, t.preventDefault(), this.toggleNow(this.$el, !0), this.animation = Mr.scale, Ae(t.target, this.clsActive), this.stack.splice(1, 0, this.index))
                }
            }, {
                name: "itemshow",
                handler: function (t) {
    ...
    var Wr = {},
        Vr = {
            ...
            methods: {
                close: function (t) {
                    function e() {
                        zt(n.$el, "close", [n]), ve(n.$el), Wr[n.pos].children.length || He(Wr[n.pos], "display", "none")
                    }
                    var n = this;
                ...
                Transitioner: function (r, i, o, t) {
                    ...
                    return {
                        ...
                        translate: function (t) {
                            ...
                            He(a, "transform", _r(Z(e - e * t - c, -Jr(a), Qr(a).width) * (Zt ? -1 : 1), "px")), this.updateTranslates(), r && (t = Z(t, -1, 1), to(this.getItemIn(), "itemtranslatein", {
                                percent: t,
                                dir: o
        ...
        co = {
            ...
            methods: {
                init: function (t) {
                    ...
                    !r || i || 0 < n || At(e) || Nt(e, "." + this.clsNoDrag) || this.handle && !Nt(e, this.handle) || (t.preventDefault(), this.touched = [this], this.placeholder = r, this.origin = X({
                        target: e,
                        index: ce(r)
                ...
                start: function (t) {
                    this.drag = fe(this.$container, this.placeholder.outerHTML.replace(/^<li/i, "<div").replace(/li>$/i, "div>")), He(this.drag, X({
                        ...
                        overflow: "hidden"
                    }, He(this.placeholder, ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom"]))), it(this.drag, "uk-no-boot", ""), Ce(this.drag, this.clsDrag, this.clsCustom), on(this.drag.firstElementChild, on(this.placeholder.firstElementChild));
                    ...
                    X(this.origin, {
                        left: n - this.pos.x,
                        top: i - this.pos.y
                    }), Ce(this.placeholder, this.clsPlaceholder), Ce(this.$el.children, this.clsItem), Ce(document.documentElement, this.clsDragState), zt(this.$el, "start", [this, this.placeholder]), this.move(t)
                },
                move: function (t) {
                    if (this.drag) {
                        this.$emit();
            ...
            methods: {
                show: function () {
                    ...
                    this.isActive() || (vo.forEach(function (t) {
                        return t.hide()
                    }), vo.push(this), this._unbind = Mt(document, re, function (t) {
                ...
                hide: function () {
                    this.isActive() && !bt(this.$el, "input:focus") && (vo.splice(vo.indexOf(this), 1), clearTimeout(this.showTimer), clearInterval(this.hideTimer), it(this.$el, "aria-expanded", !1), this.toggleElement(this.tooltip, !1), this.tooltip && ve(this.tooltip), this.tooltip = !1, this._unbind())
                },
                _show: function () {
    ...
    function ko() {
        Io(document.body, mo), xn.flush(), new MutationObserver(function (t) {
            return t.forEach($o)
        }).observe(document, {
            childList: !0,
            subtree: !0,
